...
% Rewrite transition diagram
% Revise table (make baseline vivado)

% MISC TODOS:
% (Matt): Merge marginal improvement and exec time (the sections and the figures)
% (Matt): Sweep num. stages for multiplier (and write the section)
% (Matt): On the marginal improvement plot, mention (1) saturation and (2) iterations
% (Matt): Explain the bumps and dips in the plot
% (Berk): resize plots to be legible at 100% scale
% (Berk): Add the ALU table in CSV format
