...
that every other rewrite rule can be defined for one input position, without
loss of generality. This reduces the total number of rewrite rules, making it
easier to rationalize about the rule system and which types of optimizations
are reachable.
...
mapping. For instance, a circuit that implements $F(x_0, G(x_1, x_2))$ with two
