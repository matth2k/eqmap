...
In this paper, we introduce how FPGA technology mapping can be augmented with
...
fundamentally rely on the topology of the input circuit. In this sense, they
are prone to \textit{structural bias}.
...
\begin{itemize}
    \item We formulate an intermediate language and set of e-graph rewrite rules that can
          explore a wide range of circuit topologies.
