...
technique only works for acyclic designs, we wanted to add an additional case
study on pipelined logic to demonstrate the potential of extending our approach
beyond just combinational logic.
