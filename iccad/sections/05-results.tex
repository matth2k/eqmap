...
\begin{figure}
    ...
    \begin{subfigure}{0.47\textwidth}
        ...
        \caption{Marginal cost in compile time versus iteration count.}\label{fig:marginal:runtime}
    \end{subfigure}
...
becomes prohibitive as the e-graph grows much larger.
...
By studying a parameterized design, we can demonstrate that \shortname{}'s
benefits hold the same with the scaling of logic.

To test how \shortname{} scales with gate count, we created a synthetic ALU
