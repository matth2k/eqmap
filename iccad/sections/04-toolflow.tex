...
extraction algorithms. \todo{speak on potential gains with improved extraction
    capabilities} In any case, the greedy cost of a LUT is always one plus the sum
